...
class acl extends Seeder
{
    ...
    public function run()
    {
		...
		// para especialides
		$especialidade_index = Permission::where('name', '=', 'especialidade-index')->get()->first(); 
		$especialidade_create = Permission::where('name', '=', 'especialidade-create')->get()->first();
		$especialidade_edit = Permission::where('name', '=', 'especialidade-edit')->get()->first();  
		$especialidade_delete = Permission::where('name', '=', 'especialidade-delete')->get()->first();
		$especialidade_show = Permission::where('name', '=', 'especialidade-show')->get()->first();  
		$especialidade_export = Permission::where('name', '=', 'especialidade-export')->get()->first();
		...
		#especialidade
		$administrador_perfil->permissions()->attach($especialidade_index);
		$administrador_perfil->permissions()->attach($especialidade_create);
		$administrador_perfil->permissions()->attach($especialidade_edit);
		$administrador_perfil->permissions()->attach($especialidade_delete);
		$administrador_perfil->permissions()->attach($especialidade_show);
		$administrador_perfil->permissions()->attach($especialidade_export);
		...
		$gerente_perfil->permissions()->attach($cargo_delete);
		$gerente_perfil->permissions()->attach($cargo_export);
		#especialidade
		$gerente_perfil->permissions()->attach($especialidade_index);
		$gerente_perfil->permissions()->attach($especialidade_create);
		$gerente_perfil->permissions()->attach($especialidade_edit);
		$gerente_perfil->permissions()->attach($especialidade_show);
		$gerente_perfil->permissions()->attach($especialidade_delete);
		$gerente_perfil->permissions()->attach($especialidade_export);
		...
		#especialidade
		$operador_perfil->permissions()->attach($especialidade_index);
		$operador_perfil->permissions()->attach($especialidade_show);
		$operador_perfil->permissions()->attach($especialidade_export);
		...
		#especialidade
		$leitor_perfil->permissions()->attach($especialidade_index);
		$leitor_perfil->permissions()->attach($especialidade_show);
